...
<div class="pp-settings-section">
	<div class="pp-settings-section-header">
		<h3 class="pp-settings-section-title"><?php _e( 'White Label', 'powerpack' ); ?></h3>
	</div>
		...
		<table class="form-table">
			<tbody>
				<tr valign="top">
					...
					<td>
						<input id="pp_plugin_name" name="pp_plugin_name" type="text" class="regular-text" value="<?php esc_attr_e( $settings['plugin_name'], 'powerpack' ); ?>" />
					</td>
				</tr>
				<tr valign="top">
					<th scope="row" valign="top">

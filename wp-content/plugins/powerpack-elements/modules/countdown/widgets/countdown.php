...
class Countdown extends Powerpack_Widget {
	...
	*/
	...
	private function _get_settings() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		 ...
		 * Timer labels
		 ***********************************/
		$label_years_plural = ( 'yes' === $settings['show_years'] ) ? $settings['label_years_plural'] : __( 'Years', 'powerpack' );
		$label_years_singular = ( 'yes' === $settings['show_years'] ) ? $settings['label_years_singular'] : __( 'Year', 'powerpack' );
		$label_months_plural = ( 'yes' === $settings['show_months'] ) ? $settings['label_months_plural'] : __( 'Months', 'powerpack' );
		$label_months_singular = ( 'yes' === $settings['show_months'] ) ? $settings['label_months_singular'] : __( 'Month', 'powerpack' );
		$label_days_plural = ( 'yes' === $settings['show_days'] ) ? $settings['label_days_plural'] : __( 'Days', 'powerpack' );
		$label_days_singular = ( 'yes' === $settings['show_days'] ) ? $settings['label_days_singular'] : __( 'Day', 'powerpack' );
		$label_hours_plural = ( 'yes' === $settings['show_hours'] ) ? $settings['label_hours_plural'] : __( 'Hours', 'powerpack' );
		$label_hours_singular = ( 'yes' === $settings['show_hours'] ) ? $settings['label_hours_singular'] : __( 'Hour', 'powerpack' );
		$label_minutes_plural = ( 'yes' === $settings['show_minutes'] ) ? $settings['label_minutes_plural'] : __( 'Minutes', 'powerpack' );
		$label_minutes_singular = ( 'yes' === $settings['show_minutes'] ) ? $settings['label_minutes_singular'] : __( 'Minute', 'powerpack' );
		$label_seconds_plural = ( 'yes' === $settings['show_seconds'] ) ? $settings['label_seconds_plural'] : __( 'Seconds', 'powerpack' );
		$label_seconds_singular = ( 'yes' === $settings['show_seconds'] ) ? $settings['label_seconds_singular'] : __( 'Second', 'powerpack' );
	...
	public function render_normal_countdown( $str1, $str2 ) {
		...
		<div class="pp-countdown-item">
			<div class="pp-countdown-digit-wrapper">
				<<?php echo esc_html( $digit_tag ); ?> class="pp-countdown-digit">
					<?php echo esc_attr( $str1 ); ?>
				</<?php echo esc_html( $digit_tag ); ?>>
			</div>
			<?php if ( 'yes' === $settings['show_labels'] ) { ?>
				<div class="pp-countdown-label-wrapper">
					<<?php echo esc_html( $label_tag ); ?> class="pp-countdown-label">
	...
	protected function render() {
		...
		?>
		<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'pp-countdown' ) ); ?>></div>

...
$already_in_wishlist_text = __( 'Already in Wishlist', 'powerpack' );
	...
	<div class="pp-woo-product-wrapper">
		...
		if ( '' !== $quick_view_type ) {
			...
			echo '<div class="pp-action-item-wrap pp-quick-view-btn" data-product_id="' . esc_attr( $post_id ) . '">';
				echo '<div class="pp-action-item-wrap">';
		...
		if ( class_exists( 'YITH_WCWL' ) && 'yes' === $settings['show_add_to_wishlist'] ) {
			...
			echo do_shortcode( '[yith_wcwl_add_to_wishlist link_classes="pp-action-item" already_in_wishslist_text="' . esc_attr( $already_in_wishlist_text ) . '" product_added_text="" browse_wishlist_text=""]' );
			echo '</div>';
		}

...
class FL_Custom_Modules_Example_Loader {
	...
	static public function load_modules() {
		require_once FL_MODULE_DIR . 'modules/basic-example/basic-example.php';
		require_once FL_MODULE_DIR . 'modules/example/example.php';
	}
	...
	static public function register_fields( $fields ) {
		$fields['my-custom-field'] = FL_MODULE_DIR . 'fields/my-custom-field.php';
		return $fields;
	}
	...
	static public function enqueue_field_assets() {
		...
		wp_enqueue_style( 'my-custom-fields', FL_MODULE_DIR . 'assets/css/fields.css', array(), '' );
		wp_enqueue_script( 'my-custom-fields', FL_MODULE_DIR . 'assets/js/fields.js', array(), '', true );
	}
}

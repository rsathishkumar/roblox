...
class CustomSlides extends Widget_Base {
	...
	public function get_title() {
		return __( 'Custom Slides', 'elementor-pro' );
	}
	...
	protected function _register_controls() {
        ...
        $repeater->add_control(
          'image_logo',
          [
            'label' => __( 'Logo Image', 'elementor-pro' ),
            'type' => Controls_Manager::MEDIA,
            'dynamic' => [
              'active' => true,
            ],
      ...
      $repeater->add_control(
        'notes_text',
        [
          'label' => __( 'Notes', 'elementor-pro' ),
          'type' => Controls_Manager::TEXT,
          'default' => __( 'Notes', 'elementor-pro' ),
          'label_block' => true,
        ]
      );
      ...
      $repeater->add_control(
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
                    '{{WRAPPER}} {{CURRENT_ITEM}} .swiper-slide-inner .elementor-slide-notes' => 'color: {{VALUE}}',
        ...
        $this->add_responsive_control(
          ...
          [
            ...
            'selectors' => [
              '{{WRAPPER}} .elementor-slide-logo img' => 'max-width: {{SIZE}}{{UNIT}}; max-height: {{SIZE}}{{UNIT}}',
            ],
          ]
        );
        ...
        $this->add_control(
          ...
          [
            ...
            'selectors' => [
              '{{WRAPPER}} .swiper-slide-inner .elementor-slide-logo:not(:last-child) img' => 'margin-bottom: {{SIZE}}{{UNIT}}',
            ],
          ]
        );
        ...
        $this->add_control(
          ...
          [
            ...
            'type' => Controls_Manager::SWITCHER,
            'selectors' => [
              '{{WRAPPER}} .elementor-slide-logo img' => 'border-style: solid',
            ],
          ]
        );
        ...
        $this->add_control(
          ...
          [
            ...
            'default' => '#000',
            'selectors' => [
              '{{WRAPPER}} .elementor-slide-logo img' => 'border-color: {{VALUE}}',
            ],
            'condition' => [
              'image_border' => 'yes',
            ],
        ...
        $this->add_responsive_control(
          ...
          [
            ...
            'selectors' => [
              '{{WRAPPER}} .elementor-slide-logo img' => 'border-width: {{SIZE}}{{UNIT}}',
            ],
            'condition' => [
              'image_border' => 'yes',
            ],
        ...
        $this->add_control(
          ...
          [
            ...
            'type' => Controls_Manager::SLIDER,
            'selectors' => [
              '{{WRAPPER}} .elementor-slide-logo img' => 'border-radius: {{SIZE}}{{UNIT}}',
            ],
          ]
        );
        ...
        $this->start_controls_section(
          'section_style_notes',
          [
            'label' => __( 'Notes Style', 'elementor-pro' ),
            'tab' => Controls_Manager::TAB_STYLE,
          ]
        );
        ...
        $this->add_control(
          ...
          [
            ...
            'selectors' => [
              '{{WRAPPER}} .swiper-slide-inner .elementor-slide-notes:not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}}',
            ],
          ]
        );
        ...
        $this->add_control(
          ...
          [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
              '{{WRAPPER}} .elementor-slide-notes' => 'color: {{VALUE}}',
        ...
        $this->add_group_control(
          ...
          [
            ...
            'selector' => '{{WRAPPER}} .elementor-slide-notes',
          ]
        );
	...
	protected function render() {
		...
		foreach ( $settings['slides'] as $slide ) {
            ...
            if ( $slide['image_logo'] ) {
              $slide_html .= '<div class="elementor-slide-logo"><img src="'.$slide['image_logo']['url'] .'" alt="' . $slide['heading'] . '" /></div>';
            }
            ...
            if ( $slide['notes_text'] ) {
              $slide_html .= '<div class="elementor-slide-notes">' . $slide['notes_text'] . '</div>';
            }
						...
						<div class="elementor-repeater-item-{{ slide._id }} swiper-slide">
							...
							<div class="swiper-slide-inner">
								<div class="swiper-slide-contents">
									<# if ( slide.image_logo ) { #>
                                      <div class="elementor-slide-logo"><img src="{{ slide.image_logo.url }}" alt="{{ slide.heading }}" /></div>
                                    <# }
                                    if ( slide.heading ) { #>
									...
									<# }
                                    if ( slide.notes_text ) { #>
                                      <div class="elementor-slide-notes">{{{ slide.notes_text }}}</div>
                                    <# }
                                    if ( slide.button_text ) { #>

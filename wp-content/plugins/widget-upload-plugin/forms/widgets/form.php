...
abstract class EF_Form_Base extends Widget_Base {
  ...
  protected function separator_field( $item, $item_index ) {
    $this->add_render_attribute( 'hr' . $item_index, [
      'class' => [
        'elementor-field-hr',
        'elementor-size-' . $item['input_size'],
      ],
    ...
    return '<hr ' . $this->get_render_attribute_string( 'hr' . $item_index ) . ' style="display:block" />';
  }
...
class EF_Form extends EF_Form_Base {
	...
	public function get_title() {
		return __( 'Join Talent Network Form', 'elementor-pro' );
	}
	...
	protected function _register_controls() {
		...
		$field_types = [
            ...
            'hr' => __( 'Seperator', 'elementor-pro' ),
			'hidden' => __( 'Hidden', 'elementor-pro' ),
            'custom-upload' => __( 'File Upload Button', 'elementor-pro' ),
        ];
			...
			[
				...
				'default' => [
					[
						'custom_id' => 'fname',
						'field_type' => 'text',
						'field_label' => __( 'First Name', 'elementor-pro' ),
						'placeholder' => __( 'First Name', 'elementor-pro' ),
						'width' => '25',
					],
                    [
                      'custom_id' => 'lname',
                      'field_type' => 'text',
                      'field_label' => __( 'Last Name', 'elementor-pro' ),
                      'placeholder' => __( 'Last Name', 'elementor-pro' ),
                      'width' => '25',
                    ],
					[
						'custom_id' => 'email',
                    ...
                    [
                      'custom_id' => 'location',
                      'field_type' => 'text',
                      'field_label' => __( 'Current Location', 'elementor-pro' ),
                      'placeholder' => __( 'Location', 'elementor-pro' ),
                      'width' => '25',
                    ],
                    [
                      'custom_id' => 'title',
                      'field_type' => 'text',
                      'field_label' => __( 'Current Title', 'elementor-pro' ),
                      'placeholder' => __( 'Current Title', 'elementor-pro' ),
                      'width' => '50',
                    ],
                    [
                      'custom_id' => 'company',
                      'field_type' => 'text',
                      'field_label' => __( 'Current Company', 'elementor-pro' ),
                      'placeholder' => __( 'Current Company', 'elementor-pro' ),
                      'width' => '50',
                    ],
                    [
                      'custom_id' => 'resume',
                      'field_type' => 'upload',
                      'field_label' => __( 'Resume', 'elementor-pro' ),
                      'placeholder' => __( 'Resume', 'elementor-pro' ),
                      'width' => '100',
                    ],
                    [
                      'custom_id' => 'interested',
                      'field_type' => 'select',
                      'field_label' => __( 'Interested', 'elementor-pro' ),
                      'field_options' => 'tst|test\n\rtest2|gtt',
                      'options' => [
                        'Designing' => __( 'Designing', 'elementor-pro' ),
                        'Development' => __( 'Development', 'elementor-pro' )
                      ],
                      'width' => '100',
                    ],
                    [
                      ...
                      'field_label' => __( 'Disclaimer', 'elementor-pro' ),
                      'acceptance_text' => 'Disclaimer',
                    ...
                    [
                      'custom_id' => 'subscribe',
                      'field_type' => 'acceptance',
                      'field_label' => __( '', 'elementor-pro' ),
                      'acceptance_text' => 'Subscribe Text',
		...
		$this->add_group_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-field-group > label',
        ...
        $this->add_control(
          'hr_style',
          [
            'label' => __( 'Seperator Style', 'elementor-pro' ),
            'type' => Controls_Manager::HEADING,
            'separator' => 'before',
          ]
        );
        ...
        $this->add_control(
          ...
          [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
              '{{WRAPPER}} .elementor-field-hr' => 'border-color: {{VALUE}};',
            ],
            'global' => [
              'default' => Global_Colors::COLOR_TEXT,
            ],
        ...
        $this->add_control(
          ...
          [
            ...
            'size_units' => [ 'px' ],
            'selectors' => [
              '{{WRAPPER}} .elementor-field-hr' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
          ]
        );
        ...
        $this->add_control(
          ...
          [
            ...
            'selectors' => [
              '{{WRAPPER}} .elementor-field-hr' => 'border-style: {{VALUE}}',
            ],
          ]
        );
        ...
        $this->add_control(
          'hr_margin',
          [
            'label' => __( 'Seperator Margin', 'elementor-pro' ),
            'type' => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', 'em', '%' ],
            'selectors' => [
              '{{WRAPPER}} .elementor-field-hr' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
          ]
        );
        ...
        $this->add_responsive_control(
          'label_style',
          [
            'label' => __( 'Label Display Style', 'elementor-pro' ),
            'type' => Controls_Manager::SELECT,
            'options' => [
              '' => __( 'Default', 'elementor-pro' ),
              'inlinelabel' => 'Inline'
        ...
        $this->add_control(
          ...
          [
            ...
            'selectors' => [
              '{{WRAPPER}} .e-form__indicators__indicator--state-inactive .e-form__indicators__indicator--shape-circle' => 'border-color: {{VALUE}};'
            ],
            'conditions' => [
              'terms' => [
                [
        ...
        $this->add_control(
          ...
          [
            ...
            'selectors' => [
              '{{WRAPPER}} .e-form__indicators__indicator--state-active .e-form__indicators__indicator--shape-circle' => 'border-color: {{VALUE}};'
            ],
            'conditions' => [
              'terms' => [
                [
        ...
        $this->add_control(
          ...
          [
            ...
            'selectors' => [
              '{{WRAPPER}} .e-form__indicators__indicator--state-completed .e-form__indicators__indicator--shape-circle' => 'border-color: {{VALUE}};'
            ],
            'conditions' => [
              'terms' => [
                [
        ...
        $this->add_control(
			...
			[
				...
				'selectors' => [
                  ...
                  '{{WRAPPER}} .e-form__indicators__indicator--state-completed .e-form__indicators__indicator__label' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
      ...
      <form class="elementor-form <?php echo $instance['label_style']?>" method="post" <?php echo $this->get_render_attribute_string( 'form' ); ?>>
				...
				<div <?php echo $this->get_render_attribute_string( 'field-group' . $item_index ); ?>>
					...
					switch ( $item['field_type'] ) :
						...
						case 'textarea':
							...
							break;
                        case 'hr':
                            echo $this->separator_field($item, $item_index);
                            break;
						case 'select':
	...
	protected function content_template() {
		...
		?>
		<form class="elementor-form {{settings.label_style}}" id="{{settings.form_id}}" name="{{settings.form_name}}">
				...
				<#
					for ( var i in settings.form_fields ) {
						...
						switch ( item.field_type ) {
                            ...
                            case 'email':
                              itemClasses = 'elementor-field-textual ' + itemClasses;
                              inputField = '<input size="1" type="' + item.field_type + '" value="' + item.field_value + '" class="elementor-field elementor-size-' + settings.input_size + ' ' + itemClasses + '" name="form_field_' + i + '" id="form_field_' + i + '" ' + required + ' ' + placeholder + ' pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$">';
                              break;
							default:
